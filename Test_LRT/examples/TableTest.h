...
void TableTest()
{
	...
	auto cheker_patter = std::unique_ptr<LRT::Pattern>(new LRT::CheckerPattern(Colors::white, Colors::red, glm::scale(glm::mat4(1.0f), glm::vec3(0.1f))));
	auto floor_mat = LRT::Material::Create(std::move(cheker_patter), 0.1f, 0.5f, 0.9f, 100.0f, 0.0f);

	// material for the walls
	auto striped_patter = std::unique_ptr<LRT::Pattern>(new LRT::StripedPattern({ 0.8f, 0.7f, 0.7f }, { 0.5f, 0.45f, 0.45f }, glm::scale(glm::mat4(1.0f), glm::vec3(0.1f))));
